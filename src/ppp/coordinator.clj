  ...
  (when-let [service (:repl-service coordinator)]
    ...
    (repl/eval!
     ...
     (str "(do"
          ...
          " (defn ppp-inspect-workspace-db []"
          "   (ppp-bridge/inspect-workspace-database \"" session-id "\"))"
          " (defn ppp-query-workspace-db! [sql params]"
          "   (ppp-bridge/query-workspace-database! \"" session-id "\" sql params))"
          " (defn ppp-execute-workspace-db! [sql params]"
          "   (ppp-bridge/mutate-workspace-database! \"" session-id "\" sql params))"
