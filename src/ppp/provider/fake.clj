...
(def ^:private floating-sidebar
  (str
   ...
   "     [:button {:type \"button\" :aria-label \"All projects\" :on-click all-projects!} \"Projects\"]\n"
...
(def ^:private account-server
  (str
   ...
   "(api/register-action! :auth/register signup)\n"
...
(def ^:private account-client
  (str
   ...
   "                  (if (= mode :signup) :auth/register :accounts/login)\n"
